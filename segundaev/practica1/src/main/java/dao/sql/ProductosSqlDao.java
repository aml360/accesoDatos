                ...
                for (int i = 1; i <= 9; ++i) {
                    ...
                    if (o != null) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            def = t.getDimensiones().orElse(null);
                            break;
                        case 5:
                            def = t.getProveedor().orElse(null);
                            break;
                        case 6:
                            def = t.getDescripcion().orElse(null);
                            break;
                        case 7:
                            def = t.getCantidad_en_stock();
                            break;
                        case 8:
                            def = t.getPrecio_venta();
                            break;
                        case 9:
                            def = t.getPrecio_proveedor().orElse(null);
                            break;
                        default:
                            def = null;
                        }
