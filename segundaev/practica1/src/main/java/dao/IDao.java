...
/**
 * Interfaz Data Access Object <T> con métodos para leer uno, leer varios,
...
public interface IDao<T> { // DAO
    ...
    /**
     * Devuelve todos los objetos contenidos en el Dao, en forma de lista.
     * 
     * @return Una lista con todos los objetos del Dao. La lista puede estar vacía.
     */
    List<T> todos();
